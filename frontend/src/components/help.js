            ...
            <Paper elevation={8} sx={{
                ...
                <Box sx={{ textAlign: 'center' }}>
                    ...
                    <Typography variant="h6" color="text.secondary" sx={{ mb: 3 }}>
                        Our team loves to support users! <FavoriteIcon color="error" sx={{ verticalAlign: 'text-bottom' }} />
                    </Typography>
                </Box>
                {/* Animated icons row */}
                ...
                <Box sx={{ background: '#f8f6ff', borderRadius: 4, p: 3, boxShadow: 1, mb: 4, mt: 2 }}>
                    ...
                    <Box>
                        <Typography>
                            <b>How do I book?</b>&nbsp;
                            <span style={{ color: '#764ba2' }}>Choose your service & click "Book Now".</span>
                        </Typography>
                        <Typography sx={{ mt: 1 }}>
                            <b>How to reset password?</b>&nbsp;
                            <span style={{ color: '#764ba2' }}>Open Profile & click "Change Password".</span>
                        </Typography>
                        <Typography sx={{ mt: 1 }}>
                            <b>Provider/Admin help?</b>&nbsp;
                            <span style={{ color: '#764ba2' }}>Contact our team above for support.</span>
                        </Typography>
                    </Box>
                </Box>
                {/* Feedback Form */}
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, maxWidth: 350, mx: 'auto', mt: 1 }}>
                    ...
                    <TextField label="Your Email" color="secondary" value={queryEmail} onChange={e => setQueryEmail(e.target.value)} />
                    <TextField label="Message" multiline rows={3} color="secondary" value={queryMsg} onChange={e => setQueryMsg(e.target.value)} />
                    <Button
                    ...
                    {sent && <Typography sx={{ color: '#009688', mt: 0.5 }}>Successfully sent! Our team will reply soon.</Typography>}
                </Box>
                <Typography variant="body2" align="center" sx={{ mt: 4, color: '#888' }}>
                    Team replies within 24 hours. All user roles welcome.
                </Typography>
            </Paper>
